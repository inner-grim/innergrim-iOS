...
public final class AgreementView: UIView {
    ...
    private func setupLayout() {
        ...
        allLabel.snp.makeConstraints { make in
            make.leading.equalTo(allButton.snp.trailing).offset(16)
        ...
        innergrimLabel.snp.makeConstraints { make in
            make.leading.equalTo(innergrimButton.snp.trailing).offset(16)
        ...
        privacyButton.snp.makeConstraints { make in
            make.width.height.equalTo(18)
            make.top.equalTo(innergrimButton.snp.bottom).offset(28)
            make.leading.equalToSuperview().inset(24)
        }
        
        addSubview(privacyLabel)
        privacyLabel.snp.makeConstraints { make in
            make.leading.equalTo(privacyButton.snp.trailing).offset(16)
        ...
        marketingButton.snp.makeConstraints { make in
            make.width.height.equalTo(18)
            make.top.equalTo(privacyButton.snp.bottom).offset(28)
            make.leading.equalToSuperview().inset(24)
        }
        
        addSubview(marketingLabel)
        marketingLabel.snp.makeConstraints { make in
            make.leading.equalTo(marketingButton.snp.trailing).offset(16)
        ...
        marketingDescriptionLabel.snp.makeConstraints { make in
            make.top.equalTo(marketingLabel.snp.bottom).offset(8)
